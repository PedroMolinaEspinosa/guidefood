...
class IngredientesHorizontal extends StatelessWidget {
  ...
  Widget _tarjeta(
    ...
    final tarjeta = GestureDetector(
      onTap: () {
        CustomDialog(context, ingrediente, screenSize).build(context);
      },
      child: ClipRRect(
...
class CustomDialog extends AlertDialog {
  CustomDialog(BuildContext context, Ingrediente ingrediente, Size size) {
    showDialog(
      context: context,
                    ...
                    children: <Widget>[
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: ImageIcon(
                            AssetImage(
                                "assets/iconos/Material icons-01-34.png"),
                            color: Colors.grey,
                          ),
                        ),
                      ),
                            ...
                            Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    "${ingrediente.medida} (en esta receta)",
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 2,
                                    style: titleTile,
                                  ),
